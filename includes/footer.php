  ...
  <footer class="site-footer">
    <div class="footer-grid">
      <div>
        <img src="/assets/img/bobi-yaarwin-logo.webp" alt="BOBI x YaarWin" width="130" height="130" class="footer-logo">
  ...
  <a class="floating-telegram" href="<?= e($site['telegram_url']) ?>" target="_blank" rel="nofollow noopener" aria-label="Open YaarWin Telegram bot">
